...
import { IonModal, IonButton, IonHeader, IonToolbar, IonTitle, IonContent, IonItem, IonInput, IonLabel, IonTextarea, IonGrid, IonRow, IonCol, IonFooter, IonDatetime } from "@ionic/react";
...
class AddItemModal extends Component {
  ...
  render() {
    return (
      <IonModal isOpen={this.props.showModal} onDidDismiss={() => this.props.onDidDismiss()}>
        <IonHeader>
        ...
        <IonContent padding>
          ...
          <IonItem>
            ...
            <IonDatetime display-format="MMM DD, YYYY" ref={this.dueDate} name="body" />
          </IonItem>
          <IonItem>
